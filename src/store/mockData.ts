import { Product, Category, MerchantSettings, SiteContentConfig, Order } from '../types';
...
export const defaultInitialOrdersLog: Order[] = [
  {
    ...
    totalAmount: 4850,
    shippingAddress: {
      fullName: 'Prerana Shrestha',
      phone: '9841234567',
      alternatePhone: '9801987654',
      addressLine: 'House 45, Pulchowk Height, Near Labim Mall',
      city: 'Lalitpur',
    ...
    notes: 'Please call before arriving, office hour delivery preferred.',
    courierName: 'Pathao Express Logistics',
    trackingNumber: 'PTH-KTM-9921',
    dispatchDate: new Date(Date.now() - 3600000 * 2).toISOString(),
    logisticsNotes: 'Dispatched from Kathmandu Boutique Atelier via Rider Bikash.',
    paymentDetails: {
      transactionId: 'ESEWA-TX-77192834',
      paidAt: new Date(Date.now() - 3600000 * 4).toISOString(),
    },
  },
  {
    id: 'ord-log-02',
    orderNumber: 'DAW-710492',
    items: [
      {
    ...
    shippingAddress: {
      ...
      phone: '9812984521',
      addressLine: 'Lakeside Ward 6, Near Barahi Chowk',
      city: 'Pokhara',
    ...
    notes: 'Carefully pack the cashmere pashmina in gift box.',
    courierName: 'Sundar Yatayat Cargo & Parcel',
    trackingNumber: 'SNDR-PKR-4412',
    logisticsNotes: 'Packed in signature Dawosti velvet gift box with quality seal.',
  },
  {
    id: 'ord-log-03',
    orderNumber: 'DAW-559104',
    items: [
      {
        product: mockProducts[3] || mockProducts[0],
        selectedSize: 'Free Size',
        quantity: 1,
    ...
    totalAmount: 17500,
    shippingAddress: {
      fullName: 'Aayusha Bajracharya',
      phone: '9849102938',
      addressLine: 'New Baneshwor, Shankhamul Road',
      city: 'Kathmandu',
      province: 'Bagmati Province',
      postalCode: '44600',
    },
    ...
    notes: 'Bridal function drape. Delivered successfully.',
    courierName: 'Dawosti In-House Boutique Rider',
    trackingNumber: 'DAW-LOCAL-019',
    dispatchDate: new Date(Date.now() - 3600000 * 24).toISOString(),
    logisticsNotes: 'Delivered in person. Customer confirmed fitting.',
    paymentDetails: {
      transactionId: 'FONEPAY-REF-992019',
