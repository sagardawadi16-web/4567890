...
import { Sparkles, Truck, Phone, X } from 'lucide-react';
...
export const AnnouncementBar: React.FC = () => {
  ...
  return (
    <div
      id="announcement-bar"
      className="relative z-50 bg-[#8B3A3A] text-[#FFF8F0] text-xs sm:text-sm py-2 px-3 sm:px-6 shadow-xs border-b border-[#D4AF37]/30 transition-all duration-300"
    >
      <div className="max-w-7xl mx-auto flex items-center justify-between gap-2">
        ...
        {/* Center: Main Announcement from siteContent */}
