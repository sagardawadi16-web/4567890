        ...
        <div className="w-full md:w-1/2 p-5 sm:p-8 overflow-y-auto flex flex-col justify-between space-y-5">
          ...
          <div className="space-y-3 pt-2">
            ...
            <button
              ...
              className={`w-full min-h-[48px] py-3.5 px-6 rounded-xl font-bold text-sm shadow-md flex items-center justify-center gap-2.5 transition-all active:scale-[0.97] ${
                addedAnimation
            ...
            >
              {addedAnimation ? (
                <>
                  ...
                  <span>{language === 'np' ? 'झोलामा थपियो!' : 'Added to Cart!'}</span>
                </>
              ) : (
                <>
                  ...
                  <span>
                    {language === 'np'
                      ? `झोलामा थप्नुहोस् • ${formatPrice(product.price * quantity)}`
            ...
            <a
              ...
              className="w-full min-h-[48px] py-3.5 px-6 rounded-xl font-bold text-sm bg-[#25D366] hover:bg-[#1EBE5B] text-white shadow-md flex items-center justify-center gap-2.5 transition-all active:scale-[0.97]"
            >
              <MessageCircle className="w-5 h-5 fill-white" />
              <span>
                {language === 'np'
                  ? 'व्हाट्सएपबाट सिधै अर्डर गर्नुहोस् (WhatsApp Order)'
