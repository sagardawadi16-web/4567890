          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-5 text-center lg:text-left">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-3 pt-2">
                ...
                >
                  <span>{language === 'np' ? 'सम्पूर्ण संग्रह हेर्नुहोस्' : 'Browse All Collections'}</span>
                ...
                >
                  <span>{language === 'np' ? 'च्यांग्रा पश्मिना हेर्नुहोस्' : 'Chyangra Pashmina'}</span>
                </button>
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {displaySpotlight.map((prod) => (
            ...
            >
              ...
              {/* Action Bar */}
              <div className="grid grid-cols-2 gap-2 pt-4 mt-3 border-t border-[#EADCCE]">
                <a
                  href={getWhatsAppProductOrderUrl(prod, prod.availableSizes[0] || 'Free Size', 1)}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="min-h-[44px] py-2 px-3 bg-[#25D366]/10 hover:bg-[#25D366]/20 text-[#128C7E] rounded-xl text-xs font-bold flex items-center justify-center gap-1.5 transition-all active:scale-[0.97]"
                >
                ...
                <button
                  ...
                  className="min-h-[44px] py-2 px-3 bg-[#8B3A3A] hover:bg-[#722E2E] text-white rounded-xl text-xs font-bold flex items-center justify-center gap-1.5 shadow-xs transition-all active:scale-[0.97]"
                >
