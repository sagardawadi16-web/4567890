...
export const CheckoutPage: React.FC = () => {
  ...
  const [city, setCity] = useState('Kathmandu (काठमाडौँ)');
            ...
            <div className="bg-white rounded-3xl p-5 sm:p-7 border border-[#EADCCE] shadow-xs space-y-5">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div className="space-y-1">
                    <label className="text-xs font-bold uppercase tracking-wider text-[#6B564C]">
                      {language === 'np' ? 'प्रदेश (Province)' : 'Province'}
                    </label>
                    <select
                    ...
                    >
                      <option value="Bagmati Province (बागमती प्रदेश)">Bagmati Province (बागमती प्रदेश)</option>
                      <option value="Gandaki Province (गण्डकी प्रदेश)">Gandaki Province (गण्डकी प्रदेश)</option>
                      <option value="Koshi Province (कोशी प्रदेश)">Koshi Province (कोशी प्रदेश)</option>
                      <option value="Lumbini Province (लुम्बिनी प्रदेश)">Lumbini Province (लुम्बिनी प्रदेश)</option>
                      <option value="Madhesh Province (मधेश प्रदेश)">Madhesh Province (मधेश प्रदेश)</option>
                      <option value="Sudurpashchim Province (सुदूरपश्चिम)">Sudurpashchim Province (सुदूरपश्चिम)</option>
                      <option value="Karnali Province (कर्णाली प्रदेश)">Karnali Province (कर्णाली प्रदेश)</option>
                    </select>
                  </div>

                  <div className="space-y-1">
                    <label className="text-xs font-bold uppercase tracking-wider text-[#6B564C]">
                      {language === 'np' ? 'सहर / जिल्ला (City / District)' : 'City / District'}
                    </label>
                    <select
                      ...
                      className="w-full px-3 py-2.5 bg-[#FAF2E9] border border-[#EADCCE] rounded-xl text-xs sm:text-sm font-semibold text-[#2B1810] focus:ring-2 focus:ring-[#8B3A3A] focus:outline-none cursor-pointer"
                    >
                      <option value="Kathmandu (काठमाडौँ)">Kathmandu (काठमाडौँ)</option>
                      ...
                      <option value="Chitwan (भरतपुर/चितवन)">Chitwan (भरतपुर/चितवन)</option>
                      <option value="Butwal (बुटवल)">Butwal (बुटवल)</option>
                      <option value="Biratnagar (विराटनगर)">Biratnagar (विराटनगर)</option>
                      <option value="Dharan (धरान)">Dharan (धरान)</option>
                      <option value="Nepalgunj (नेपालगन्ज)">Nepalgunj (नेपालगन्ज)</option>
                      <option value="Other Districts (अन्य जिल्ला)">Other Districts (अन्य जिल्ला)</option>
                    </select>
                  </div>
                </div>
              ...
              <div className="text-center pt-2">
                <a
                  href={`https://wa.me/9779801234567?text=${encodeURIComponent(
                    `🙏 Namaste Dawosti Boutique! I need help with checkout for total ${formatPrice(totalPayable)}. My name is ${fullName || 'Customer'}.`
                  )}`}
                  target="_blank"
                ...
                >
                  ...
                  <span>{language === 'np' ? 'व्हाट्सएपबाट अर्डर सहायता लिनुहोस्' : 'Need help? Order via WhatsApp'}</span>
                </a>
              </div>
